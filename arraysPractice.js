...
// Your job is to write a function named finder that will get a random number (by invoking getRandomArbitrary), then loop through the array (that will be passed in as a parameter) to see if that random number is in the array. If it is, return true, if it's not, return false
  ...
  //Code Here
var finder = (arr) => arr.indexOf(getRandomArbitrary()) === -1 ? false : true;
...
//array after adding ten to each item in numbers. *Verify your answer is correct. --> [15, 19, 26, 29, 35, 44, 58]
  ...
  //Code Here
var addTen = numbers => numbers.map(a => parseInt(a) + 10);
...
var both = (arr1,arr2) => arr2.filter((n) => arr1.indexOf(n) !== -1);
...
Loop through your devMountainEmployees until you find cahlan, then remove him from the array.*/
  ...
  //Code Here
devMountainEmployees.filter((n) => n.name !== 'Cahlan');
...
Once you find the particular index he's located in, delete him from the array.*/
  ...
  //Code Here
    users.filter(a => a.email !== 'tylermcginnis33@gmail.com');
